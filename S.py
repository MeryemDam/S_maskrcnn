...
class SDataset(utils.Dataset):
    ...
    def load_S(self, dataset_dir, subset):
        ...
        for a in annotations:
            ...
            self.add_image(
                "S",  ## for a single class just add the name here
...
def train(model):
    ...
    dataset_train.load_S(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = SDataset()
    dataset_val.load_S(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect S letter class.')
